    ...
    <div v-if="modalExcluir" class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
      <div class="bg-white rounded-xl w-full max-w-md p-6">
        ...
        <p class="text-sm text-gray-500 mb-4">
          Isso remove permanentemente sua conta e todos os seus dados (documentos, propostas, agendamentos,
...
const props = defineProps({ provider: Object, motivosExclusao: Object })
...
function confirmarExclusao() {
  excluirForm.delete(route('prestador.perfil.destroy'))
}
</script>
