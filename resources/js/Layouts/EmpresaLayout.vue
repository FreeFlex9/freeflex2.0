    ...
    >
      ...
      <nav class="flex-1 overflow-y-auto py-4 px-3 space-y-0.5">
        ...
        <Link :href="route('empresa.demandas.create')"
          :class="isActive('/empresa/demandas/nova') ? 'bg-teal-50 text-teal-700 font-medium' : 'text-gray-600 hover:bg-gray-100 hover:text-gray-800'"
          class="flex items-center gap-2.5 px-3 py-2 rounded-lg text-sm transition-colors">
        ...
        <Link :href="route('empresa.demandas.index')"
          :class="isActive('/empresa/demandas') && !isActive('/empresa/demandas/nova') ? 'bg-teal-50 text-teal-700 font-medium' : 'text-gray-600 hover:bg-gray-100 hover:text-gray-800'"
          class="flex items-center gap-2.5 px-3 py-2 rounded-lg text-sm transition-colors">
        ...
        <!-- Avaliações -->
        <Link :href="route('empresa.avaliacoes.index')"
          :class="isActive('/empresa/avaliacoes') ? 'bg-teal-50 text-teal-700 font-medium' : 'text-gray-600 hover:bg-gray-100 hover:text-gray-800'"
          class="flex items-center gap-2.5 px-3 py-2 rounded-lg text-sm transition-colors">
